...
def combine_hours(group):
    try:
        ...
        print(f"Error al combinar los periodos: {e}")
        return None
    
def process_data_for_report(df_dict):
    ...
    with open('reporte_mem.xlsx', 'wb') as f:
        f.write(output_file.getvalue())
    
    # Mensaje de confirmación
    print("El reporte se ha generado y guardado como 'reporte_generado_mem.xlsx'")